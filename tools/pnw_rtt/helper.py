...
class PNWMixedNetworkPathRTTSimulator(PNWMixedNetworkRTTSimulator):
	...
	#
    def generate_rtts(self, lambd, userType):
        govt = dict([(0.15, (0, .01)),
                (0.21, (.0001, .01)),
                (0.27, (.005, .02)),
                (0.35, (.007, .02)),
                (0.42, (.01, .025)),
                (0.5, (.013, .05))])
        senior = dict([(0.15, (0.0001, 0.1)),
                (0.21, (.0005, .15)),
                (0.27, (.04, .2)),
                (0.35, (.08, .28)),
                (0.42, (.12, .4)),
                (0.5, (.21, .51))])
        normal = dict([(0.15, (.11, .2)),
                (0.21, (.2, .29)),
                (0.27, (.28, .38)),
                (0.35, (.27, .47)),
                (0.42, (.51, .52)),
        ...
        for i in range(self._datapoints_per_run):
            ...
            adjustment = (hf * types[userType][lambd][0]) + (ncb * types[userType][lambd][1]) - (qos * QoS[lambd])
            total_rtt += adjustment
            print(types[userType][lambd][0], types[userType][lambd][1], QoS[lambd], adjustment, total_rtt)
